...
public final class ShardingOperateAPIImpl implements ShardingOperateAPI {
    ...
    @Override
    public void disable(String jobName, String item, String userName) {
        disableOrEnableJobs(jobName, item, true, userName);
    }

    @Override
    public void enable(String jobName, String item, String userName) {
        disableOrEnableJobs(jobName, item, false, userName);
    }

    private void disableOrEnableJobs(final String jobName, final String item, final boolean disabled, final String userName) {
        JobNodePath jobNodePath = new JobNodePath(jobName);
        String shardingDisabledNodePath = jobNodePath.getShardingNodePath(item, "disabled", userName);
        if (disabled) {
